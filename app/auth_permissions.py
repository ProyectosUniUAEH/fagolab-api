...
PERMISSIONS: tuple[PermissionDef, ...] = (
    ...
    permission("secuenciacion.records.view", "Consultar secuenciaciones.", kind="vista", route="/secuenciacion"),
    permission("secuenciacion.records.create", "Registrar secuenciaciones."),
    permission("secuenciacion.records.update", "Editar o eliminar secuenciaciones."),
    permission("secuenciacion.files.manage", "Subir y eliminar archivos FASTQ/FASTA."),
    permission("analisis.corridas.view", "Consultar corridas de análisis y coincidencias BLAST."),
    permission("analisis.corridas.create", "Lanzar el análisis automatizado de una secuencia."),
    permission("analisis.tools.view", "Consultar el catálogo de herramientas."),
    permission("analisis.orquestacion.run", "Ejecutar el análisis completo con un solo disparo."),
    permission("analisis.tools.execute", "Ejecutar herramientas del catálogo directamente.", risk="alto"),
    permission("ficha.records.view", "Consultar fichas científicas generadas."),
    permission("ficha.records.create", "Generar fichas científicas con el modelo de IA."),
    permission("ficha.records.delete", "Eliminar fichas científicas.", risk="alto"),
...
ACL_RULES: tuple[AclRule, ...] = (
    ...
    # Secuenciación: las rutas literales van antes que las paramétricas.
    rule("GET", r"/api/secuenciaciones/candidatos", "secuenciacion.records.view"),
    rule("DELETE", r"/api/secuenciaciones/archivos/[0-9a-fA-F-]+", "secuenciacion.files.manage"),
    rule("GET", r"/api/secuenciaciones/archivos/[0-9a-fA-F-]+/vista-previa", "secuenciacion.records.view"),
    rule("GET", r"/api/secuenciaciones", "secuenciacion.records.view"),
    rule("POST", r"/api/secuenciaciones", "secuenciacion.records.create"),
    rule("GET", r"/api/secuenciaciones/[0-9a-fA-F-]+", "secuenciacion.records.view"),
    rule("PATCH", r"/api/secuenciaciones/[0-9a-fA-F-]+", "secuenciacion.records.update"),
    rule("DELETE", r"/api/secuenciaciones/[0-9a-fA-F-]+", "secuenciacion.records.update"),
    rule("POST", r"/api/secuenciaciones/[0-9a-fA-F-]+/archivos", "secuenciacion.files.manage"),
    # Análisis automatizado y catálogo de herramientas.
    rule("POST", r"/api/secuenciaciones/[0-9a-fA-F-]+/analisis", "analisis.corridas.create"),
    rule("GET", r"/api/secuenciaciones/[0-9a-fA-F-]+/analisis", "analisis.corridas.view"),
    rule("GET", r"/api/secuenciaciones/[0-9a-fA-F-]+/hits", "analisis.corridas.view"),
    rule("GET", r"/api/analisis/[0-9a-fA-F-]+", "analisis.corridas.view"),
    rule("POST", r"/api/secuenciaciones/[0-9a-fA-F-]+/arbol", "analisis.corridas.create"),
    rule("GET", r"/api/orquestacion/definicion", "analisis.corridas.view"),
    rule("POST", r"/api/secuenciaciones/[0-9a-fA-F-]+/orquestar", "analisis.orquestacion.run"),
    rule("POST", r"/api/secuenciaciones/[0-9a-fA-F-]+/experimento", "ficha.records.create"),
    rule("GET", r"/api/experimentos/variables", "ficha.records.view"),
    rule("POST", r"/api/secuenciaciones/[0-9a-fA-F-]+/ficha", "ficha.records.create"),
    rule("GET", r"/api/secuenciaciones/[0-9a-fA-F-]+/fichas", "ficha.records.view"),
    rule("GET", r"/api/secuenciaciones/[0-9a-fA-F-]+/evidencia", "ficha.records.view"),
    rule("DELETE", r"/api/fichas/[0-9a-fA-F-]+", "ficha.records.delete"),
    rule("GET", r"/api/tools", "analisis.tools.view"),
    rule("POST", r"/api/tools/[a-z0-9_]+", "analisis.tools.execute"),
